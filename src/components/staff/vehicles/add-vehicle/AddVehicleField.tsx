  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        className={`font-roboto w-full rounded-xl border bg-elevated px-4 py-3.5 text-sm text-foreground outline-none transition-colors placeholder:text-secondary/80 focus:border-accent/35 ${
          error
