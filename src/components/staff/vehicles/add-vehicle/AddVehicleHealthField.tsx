      ...
      {value.noteOpen && (
        <div className="space-y-2">
          <textarea
            ...
            className={`font-roboto w-full resize-none rounded-xl border bg-input-muted px-4 py-3 text-sm text-foreground outline-none transition-colors placeholder:text-secondary/70 focus:border-accent/35 ${
              error
