...
export function OpenRequestRow({
  ...
  return (
    ...
    >
      <span className="concierge-avatar flex size-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#DCC694] to-[#584D43] font-copperplate text-[15px] tracking-[0.04em] text-[#0A0806]">
