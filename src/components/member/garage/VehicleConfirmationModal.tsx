...
const confirmationOverlayClass =
  "fixed inset-0 z-[60] flex items-start justify-center p-3 sm:p-4 pt-20 sm:pt-24";
      ...
      <div className={confirmationOverlayClass}>
        ...
        <div className="relative z-10 w-full max-w-[420px] rounded-[28px] border border-accent/20 bg-background p-5 sm:p-6 shadow-[var(--shadow-modal)]">
          ...
          <div className="mb-5 sm:mb-6 flex items-center gap-3">
            ...
            <p className="font-copperplate text-[14px] sm:text-[15px] tracking-[0.06em] text-foreground uppercase">
              Reject vehicle
            </p>
          </div>
