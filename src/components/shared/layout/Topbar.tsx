...
export function Topbar({
  ...
  return (
    <>
      <header className="topbar fixed top-0 right-0 left-0 z-30 flex h-[72px] shrink-0 items-center justify-between gap-3 border-b border-foreground/10 bg-[var(--shell-bg)] px-4 sm:px-6 lg:left-[330px] lg:px-8">
        <nav
