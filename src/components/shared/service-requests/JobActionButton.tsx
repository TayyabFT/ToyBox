...
const variantClass: Record<JobButtonVariant, string> = {
  outline:
    "border border-accent/10 bg-card text-primary hover:border-primary/35",
  gold: "border border-transparent bg-gradient-to-r from-[#DCC694] to-[#584D43] text-dark hover:opacity-90",
