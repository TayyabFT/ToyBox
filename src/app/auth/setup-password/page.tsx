...
function PasswordRequirements({ password, visible }: PasswordRequirementsProps) {
  ...
  return (
    <div className="rounded-lg border border-[#DCC69422] bg-[#0D0C0A] px-4 py-3.5 space-y-2">
      <p className="font-copperplate text-[9px] tracking-[0.22em] text-[#DCC694] uppercase">
        ...
        <div className="w-full max-w-[490px] rounded-2xl border border-[#DCC6941F] px-9 py-7 backdrop-blur-xl space-y-8 bg-[#11100C80]">
          ...
          <div className="space-y-2">
            <h2 className="font-copperplate text-center text-2xl tracking-[0.20em] text-[#F2EAD5]">
              Set Your <span className="text-[#DCC694]">Password</span>
            </h2>
